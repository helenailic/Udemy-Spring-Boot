...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		appDAO.update(tempStudent); //updates student and associated courses
		System.out.println("Done");
	}
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		...
		appDAO.save(tempCourse); //save cascades to the students
		System.out.println("Done");
	...
	private void deleteCourseAndReviews(AppDAO appDAO) {
		...
		appDAO.deleteCourseById(theId); //cascade type all so it will delete the course and the reviews
		System.out.println("Done");
	}
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		...
		//save course ... and leverage cascade all to save the reviews
	...
	private void findCoursesForInstructor(AppDAO appDAO) {
		...
		//doesn't load course because the courses are lazy loaded...use new method
	...
	private void findInstructorWithCourses(AppDAO appDAO) {
		...
		Instructor tempInstructor = appDAO.findInstructorById(theId);
		//doesn't load course because the courses are lazy loaded

		System.out.println("tempInstructor: " + tempInstructor);
		//and then session automatically closes
		System.out.println("the associated courses: " + tempInstructor.getCourses());
		System.out.println("Done");
	}
