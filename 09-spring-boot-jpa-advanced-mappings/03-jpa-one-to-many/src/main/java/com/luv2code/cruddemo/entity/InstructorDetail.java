...
public class InstructorDetail {
    ...
    //this annotation makes it a bidirectional onetoone relationship
    //@OneToOne(mappedBy = "instructorDetail", cascade = CascadeType.ALL)
    //all types except CascadeType.REMOVE (only doesn't cascade the remove operation on an instructordetail)
